### 导言
---
监控数据时，实时动态曲线视图是非常常用的工具。这种视图能够实时显示数据的变化趋势，帮助我们更加直观地观察和分析数据的波动情况。
在bilibili，一个博主分享了它的作品：
![[偷偷分享一个Qt QML的实时动态曲线功能.mp4]]
...
### 二、进一步修改
---
在CMakeLists.txt里添加Charts模块，不然qml会说找不到ChartView。
![[Pasted image 20240903074410.png]]

要使用QApplecation来初始化GUI，否则程序会崩溃。
![[Pasted image 20240903074438.png]]
